  ...
  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
      ...
      {patients.map(patient =>
          <tr key={patient.id}>
            ...
            <td style={{ borderBottom: '1px solid #ddd', padding: '8px' }}><a href={`http://127.0.0.1:8000/${patient.image}`}> View </a></td>
          <td style={{ borderBottom: '1px solid #ddd', padding: '8px' }}>{patient.diagnosis}</td>
